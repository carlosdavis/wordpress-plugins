...
Donate link: http://rmarsh.com/donate/recent-comments/
Tags: comments, posts, recent, latest, newest, recent comments, post-plugins
...
Recent Comments displays a list of your blog's newest comments. The output can be customised in [many](http://rmarsh.com/plugins/post-options/) ways. 
...
1. Put `<?php recent_comments(); ?>` at the place in your template where you want the list to appear or use the plugin as a widget.

1. Use the **Options/Settings** page to adjust the behaviour of the plugin.

[My web site](http://rmarsh.com/) has [full instructions](http://rmarsh.com/plugins/recent-comments/) and [information on customisation](http://rmarsh.com/plugins/post-options/).
...
* [previous versions](http://rmarsh.com/plugins/recent-comments/)
